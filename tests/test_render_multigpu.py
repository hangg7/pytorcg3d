...
class TestRenderMeshesMultiGPU(TestCaseMixin, unittest.TestCase):
    ...
    def test_mesh_renderer_to(self):
        ...
        lights.location = torch.tensor([0.0, 0.0, +1000.0], device=device1)[
            None
        ]
        ...
        blend_params = BlendParams(
            ...
            background_color=torch.zeros(
                3, dtype=torch.float32, device=device1
            ),
        )
    ...
    def test_render_meshes(self):
        ...
        class Model(nn.Module):
            ...
            def forward(self, verts, texs):
                ...
                test._check_mesh_renderer_props_on_device(
                    self.renderer, verts.device
                )
